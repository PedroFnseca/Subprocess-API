...
async function sendMAil(lending) {
  const { user_email, user_name, book_name, return_prediction, lending_code } =
    lending;

  // Formata a data para o padrao brasileiro
  const return_prediction_formatted =
    return_prediction.toLocaleDateString("pt-BR");
